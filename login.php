...
<body>
	<form action="http://localhost/codelgniter2/index.php/Register/login" method="POST">
	<section class="h-100">
					...
					<div class="card shadow-lg">
						...
						<div class="card-footer py-3 border-0">
							<div class="text-center">
								Don't have an account? <a href="http://localhost/codelgniter2/index.php/welcome/register/register.php" class="text-dark">Create One</a>
							</div>
						</div>
					</div>
